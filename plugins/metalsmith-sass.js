...
function isAnySassFile(filename) {
...
function compile(config, basePath, files, filename, done) {
...
async function compileSass(config, files, metalsmith, done) {
    /**
    ...
    for (const file of Object.keys(files)) {
        await compile(config, basePath, files, file, done);
    }
