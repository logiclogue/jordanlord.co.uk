    ...
    .use(shortcodes({
        ...
        shortcodes: {
            ...
            ez_susa_screen: (buf, opts) => {
                return `<canvas class="u-full-width logiclogue-ez-susa-screen" data-ram-id="example-${opts.id}" width="${opts.width || 256}" height="${opts.height || 192}" style="image-rendering: pixelated; cursor: none;"></canvas>`;
            }
        }
    }))
    .use(highlight())
